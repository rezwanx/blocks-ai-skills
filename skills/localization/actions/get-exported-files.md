...
```
GET $API_BASE_URL/uilm/v1/Key/GetUilmExportedFiles?projectKey=$X_BLOCKS_KEY&pageNumber=1&pageSize=20
```
...
```bash
curl --location \
  "$API_BASE_URL/uilm/v1/Key/GetUilmExportedFiles?projectKey=$X_BLOCKS_KEY&pageNumber=1&pageSize=20" \
