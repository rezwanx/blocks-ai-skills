...
```
GET $API_BASE_URL/communication/v1/Mail/GetMailBoxMails
```
...
```bash
curl --location "$API_BASE_URL/communication/v1/Mail/GetMailBoxMails?page=1&pageSize=20&projectKey=$PROJECT_SLUG" \
