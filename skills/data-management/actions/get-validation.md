...
```
GET $API_BASE_URL/uds/v1/data-validations/get-by-id
```
...
```bash
curl --location "$API_BASE_URL/uds/v1/data-validations/get-by-id?validationId=$VALIDATION_ID&projectKey=$PROJECT_SLUG" \
