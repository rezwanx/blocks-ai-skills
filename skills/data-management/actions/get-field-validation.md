...
```
GET $VITE_API_BASE_URL/uds/v1/data-validations/schema/{schemaId}/field/{fieldName}
```
...
```bash
curl --location "$VITE_API_BASE_URL/uds/v1/data-validations/schema/$SCHEMA_ID/field/$FIELD_NAME" \
